...
public class BoardDto {
	...
	public String toString() {
		return "BoardDto [bGroupKind=" + bGroupKind + ", bId=" + bId + ", bName=" + bName + ", bTitle=" + bTitle
				+ ", bContent=" + bContent + ", bWriteTime=" + bWriteTime + ", bUpdateTime=" + bUpdateTime + ", bHit="
				+ bHit + ", bGroup=" + bGroup + ", bStep=" + bStep + ", bIndent=" + bIndent + ", bDelete=" + bDelete
				+ ", bLike=" + bLike + ", bDislike=" + bDislike + "]";
	}
