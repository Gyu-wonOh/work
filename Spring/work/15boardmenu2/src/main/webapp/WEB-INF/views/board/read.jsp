...
<%@include file="../include/header.jsp"%>
	...
	<div class="main">
		<form role="form" method="post">
			...
			<h2>카테고리
				<input type= "text" name='bGroupKind' style="width:100%" value="${boardDto.bGroupKind }">
			</h2>
			<h1>제목</h1>
			<h2>
	...
	<button type="button" class="btn btn-bLike">좋아요${boardDto.bLike }</button>
	<button type="button" class="btn btn-reply">답글</button>
</div>
</div>
