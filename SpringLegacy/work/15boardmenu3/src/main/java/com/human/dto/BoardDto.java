...
public class BoardDto {
	...
	public String toString() {
		return "BoardDto [bId=" + bId + ", bGroupKind=" + bGroupKind + ", bTitle=" + bTitle + ", bContent=" + bContent
				+ ", bEtc=" + bEtc + ", bName=" + bName + ", bWriteTime=" + bWriteTime + ", bUpdateTime=" + bUpdateTime
				+ ", bHit=" + bHit + ", bGroup=" + bGroup + ", bStep=" + bStep + ", bIndent=" + bIndent + ", bDelete="
				+ bDelete + ", bLike=" + bLike + ", bDislike=" + bDislike + "]";
	}
