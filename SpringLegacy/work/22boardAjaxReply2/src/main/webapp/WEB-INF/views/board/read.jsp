...
<script>
	...
	function getPageList(page) {
		...
		$(".btnLike").on("click", function() {
			fObject.attr("action", "/ex/board/bLike")
			fObject.submit();
		});
		$(".btnDislike").on("click", function() {
			fObject.attr("action", "/ex/board/bDislike")
			fObject.submit();
		});
	});
</script>
...
<body>
	...
	<div class="row">
		...
		<div class="main">
			...
			<h2>
				제목 <input type="text" style="width: 100%" name='bTitle'
			...
			<div class="box-footer">
				...
				<button type="submit" class="btnDislike">싫어요:
					${boardDto.bDislike }</button>
				<br>
				<br>
